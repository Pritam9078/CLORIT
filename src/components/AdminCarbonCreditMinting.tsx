...
const ADMINCarbonCreditMinting: React.FC = () => {
  ...
  return (
    <div className="p-8">
      ...
      <header className="mb-8">
        <h1 className="text-3xl font-bold">ADMIN Carbon Credit Minting</h1>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-800 break-all">
                0xADMINWalletAddress1234567890abcdef123456
              </p>
            </div>
...
export default ADMINCarbonCreditMinting;
