...
interface LandingPageProps {
  onRoleSelect?: (role: 'community' | 'ngo' | 'admin') => void;
}
...
const LandingPage2: React.FC<LandingPageProps> = ({ onRoleSelect }) => {
  ...
  const handleRoleSelection = (role: 'community' | 'ngo' | 'admin') => {
          ...
          <div style={styles.roleGrid}>
            {roleData.map((role, index) => (
              <div
                ...
                onClick={() => handleRoleSelection(role.id as 'community' | 'ngo' | 'admin')}
                onMouseEnter={(e) => {
