...
import { listCredits, buyCredits, getSigner } from '../services/blockchain';
  ...
  useEffect(() => {
    const notificationInterval = setInterval(() => {
      const messages = [
        ...
        "New ADMIN verification completed",
  ...
  const executeTrade = async () => {
    ...
    try {
      ...
      if (tradeType === 'buy') {
        ...
        try {
          // In our refactored contract, we buy from a listing
          const listingId = 0; // Placeholder for demonstration
          const totalPrice = (amount * price).toString();
          const tx = await buyCredits(listingId, amount, totalPrice, false);
          ...
          alert(`✅ Buy Order Executed on-chain!\nHash: ${tx.hash}`);
        } catch (error: any) {
          console.error(error);
        ...
        // Sell logic (Listing credits)
        setIsProcessing(true);
        try {
          const tokenId = 1; // Default token ID for CCT
          const tx = await listCredits(tokenId, amount, price.toString());
  ...
  const renderMarketplace = () => (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-2">
        {['All', 'Blue Carbon Projects', 'CCT Marketplace', 'Admin Verified', 'Corporate Buyers'].map((category) => (
          <button
            key={category}
            ...
            <div className="p-6">
              ...
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="flex items-center space-x-1 ml-2">
                  ...
                  {item.admin && <Shield className="w-4 h-4 text-blue-500" />}
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button
                    ...
                    className={`text-xs py-1 px-2 rounded transition-colors ${networkId === '0x1'
                  ...
                  <button
                    ...
                    className={`text-xs py-1 px-2 rounded transition-colors ${networkId === '0x89'
        ...
        <div className={`${cardClass} rounded-xl border p-6`}>
          ...
          <div className="flex bg-gray-100 rounded-lg p-1 mb-4">
            <button
              ...
              className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${tradeType === 'buy'
            ...
            <button
              ...
              className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${tradeType === 'sell'
          ...
          <div className="mb-4">
            <div className="flex bg-gray-100 rounded-lg p-1">
              <button
                ...
                className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${orderType === 'market'
                    ? 'bg-blue-500 text-white'
                    : 'text-gray-600 hover:text-gray-900'
                  }`}
              >
              ...
              <button
                ...
                className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${orderType === 'limit'
                    ? 'bg-blue-500 text-white'
                    : 'text-gray-600 hover:text-gray-900'
                  }`}
              >
          ...
          <button
            ...
            className={`w-full font-medium py-2 px-4 rounded-lg transition-colors flex items-center justify-center gap-2 ${!walletConnected
            ...
            <nav className="hidden md:flex space-x-8">
              {[
                ...
                <button
                  ...
                  className={`flex items-center space-x-2 px-3 py-2 rounded-lg transition-colors ${activeTab === id
          ...
          <div className={`${cardClass} rounded-xl p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto`}>
            ...
            <div className="flex space-x-4">
              <button
                ...
                className="flex-1 bg-blue-500 hover:bg-blue-600 text-white font-medium py-3 px-6 rounded-lg transition-colors flex items-center justify-center"
              >
