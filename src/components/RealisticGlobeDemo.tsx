...
const RealisticGlobeDemo: React.FC = () => {
  const [userRole, setUserRole] = useState<'ngo' | 'admin'>('admin');
  ...
  const toggleRole = () => {
    setUserRole(prev => prev === 'admin' ? 'ngo' : 'admin');
  };
        ...
        <div style={styles.headerContent}>
          ...
          <div style={styles.controls}>
            ...
            <button
              ...
              onClick={toggleRole}
            >
              {userRole === 'admin' ? '🏛️ ADMIN' : '🌿 NGO Verifier'}
            </button>
          </div>
        </div>
      </header>
