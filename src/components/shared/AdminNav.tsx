...
const AdminNav: React.FC = () => {
    ...
    return (
        <header className="sticky top-0 z-[100] w-full bg-white/90 backdrop-blur-xl border-b border-orange-100 shadow-sm">
                ...
                <div className="flex justify-between items-center h-20">
                    ...
                    <div className="hidden xl:flex items-center gap-4">
                        ...
                        {walletState?.isConnected ? (
                            <div className="flex items-center gap-1.5 px-2 py-1 bg-orange-50 border border-orange-100 rounded-lg text-[10px] font-bold text-orange-700 cursor-pointer group relative"
                                ...
                                <span className="text-orange-600 bg-white px-1 py-0 rounded border border-orange-100">
                        ...
                        <div className="relative">
                            ...
                            >
                                ...
                                <div className="text-left">
                                    <p className="text-xs font-bold text-slate-800 line-clamp-1 max-w-[100px]">{currentUser?.name || 'ADMIN'}</p>
            ...
            {/* Mobile Menu Content */}
            {isMobileMenuOpen && (
                <div className="xl:hidden bg-white border-t border-orange-50 px-4 py-6 space-y-4 animate-in slide-in-from-top-4 duration-300 shadow-xl">
                        ...
                        {walletState?.isConnected ? (
                            <div className="flex items-center justify-between px-4 py-3 bg-orange-50 border border-orange-100 rounded-xl">
                                <div className="flex items-center gap-2">
                                    ...
                                    <div>
                                        <p className="text-xs font-bold text-orange-700">{WalletUtils.formatAddress(walletState.address!)}</p>
                                        <p className="text-xs text-orange-600">{parseFloat(walletState.balance).toFixed(3)} ETH</p>
                                    </div>
                                </div>
                                <button
                                    onClick={handleWalletDisconnect}
                    ...
                    <div className="pt-4 border-t border-slate-100 space-y-2">
                        <div className="px-4 py-2">
                            ...
                            <p className="text-sm font-bold text-slate-800 mt-1">{currentUser?.name || 'ADMIN'}</p>
                        </div>
                        <button
                            onClick={() => {
                                navigate('/admin-system-control');
